# Karte von morgen RFCs

***TODO: Adopt contents as needed***

[KVM RFCs]: #kartevonmorgen-rfcs

Many changes, including bug fixes and documentation improvements can be
implemented and reviewed via the normal GitHub pull request workflow.

Some changes though are "substantial", and we ask that these be put through a
bit of a design process and produce a consensus among the *Karte von morgen* community.
...
*Karte von morgen*, *OpenFairDB* or the RFC process itself. What constitutes a
"substantial" change is evolving based on community norms and varies depending
on what part of the ecosystem you are proposing to change, but may include the
following.

  - Any semantic change to the project that is not a bugfix.
  - Removing features, including those that are feature-gated.
  - Changes to the interface between the *OpenFairDB* and *Karte von morgen*

Some changes do not require an RFC:

  - Reorganizing, refactoring, or otherwise "changing shape does
    not change meaning".
  - Additions that strictly improve objective, numerical quality criteria
    (warning removal, speedup, better platform coverage, more parallelism, trap
    more errors, etc.)
  - Additions only likely to be _noticed by_ other developers of the project,
...
Low quality proposals, proposals for previously-rejected features, or those that don't fit
...
"active" and may be implemented with the goal of eventual inclusion into *Karte von morgen*.
  ...
  - At some point, a member of the core-team will propose a "motion for final
    ...
    strong consensus *against* that position outside of the core-team. Core-team
...
feature as a pull request to the kartevonmorgen or openfairdb repo.
...
are well understood. When a decision is made, the RFC pull request
...
associated issue tracking its implementation in the kartevonmorgen or 
openfairdb repository; thus that associated issue can be assigned a priority 
via the triage process that the team uses for all issues in the
kartevonmorgen or openfairdb repository.
...
[RFC repository]: http://github.com/kartevonmorgen/rfcs
[core-team]: http://bildungsagenten.org/kartevonmorgen/
